...
if(isset($_POST['submit_login'])){
    ...
    $c_username         =   validateEmail($raw_username);
    ...
    if($row){
        ...
        keepmsg('<div class="alert alert-success text-center">
                      ...
                      <strong>Olá </strong>' . $d_name . '  bem vindo.
                </div>');
         ...
         echo '<div class="alert alert-danger text-center">
              <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
              <strong>Desculpe!</strong> Usuario não existe.
            </div>';
...
?>
  ...
  <div class="row">
      <div class="col-md-4 col-md-offset-4">
          <p class=""><a class="pull-right" href="admin/register_admin.php"> Cadastro</a></p><br>
      </div>
      <div class="col-md-4 col-md-offset-4">
        <form class="form-horizontal" role="form" method="post" action="index.php">
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="email" name="username" class="form-control" id="email" placeholder="Email cadastrado" required>
            </div>
          </div>
          <div class="form-group">
